...
export function SettingsPage() {
  ...
  const [localFluidDatabase, setLocalFluidDatabase] = useState({});
  ...
  const updateTankSetting = (index, field, value) => {
