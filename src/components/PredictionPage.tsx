...
export function PredictionPage() {
  ...
  function calculateR2(x: number[], y: number[], slope: number, intercept: number): number {
  ...
  const getTrendDescription = (slope: number): string => {
  ...
  const getAccuracyDescription = (r2: number): string => {
